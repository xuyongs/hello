...
<html>
<head>
	<title>停巴-后台管理系统</title>
	<link rel="icon" href="${msUrl}/static/images/stopbar.ico" type="image/x-icon"/>
	<%@include file="/WEB-INF/jsp/view/resource.jsp" %>
	<link rel="stylesheet" type="text/css" href="${msUrl}/static/css/main.css">
	<script type="text/javascript" src="${msUrl}/static/js/ux/main/main.js"></script>
</head>
...
<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
	<div class="panel-header" style="border: none;text-align: center;" ><%--CopyRight &copy; 2012 Swing --%>版权所有：停巴互联网科技（上海）有限公司 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;官方网址:<a href="http://www.stopbar.com.cn:8087"  target="_blank">http://www.stopbar.com.cn</a>  &nbsp;&nbsp;</div>
</div>
<!-- 中间内容页面 -->
	...
	<div class="easyui-tabs" id="tab-box" data-options="fit:true,border:false">
		<div title="首页" style="padding:20px;overflow:hidden;">
			<div style="margin-top:10%; margin-left: 25%">
				...
				<img  style="text-align:center" alt="wode" src="static/images/login/welcome.png">
			</div>
