	...
	var _this = {
		...
		addLine: function(data){
			...
			$(".remove-btn",line).click(function(){
				...
				YiYa.confirm('提示','你确定要删除所有记录吗？',function(r){
					if(r){
						_this.delLine(line);
					}
				})
  			...
  			dataGrid:{
  				title:'系统菜单列表',
	   			...
	   			columns:[[
					...
					{field:'rank',title:'排名',align:'right',width:80,sortable:true,align:'center'},
					{field:'url',title:'URL',width:220,sortable:true,align:'center'},
					{field:'createTime',title:'创建时间',width:120,sortable:true,align:'center'},
					{field:'updateTime',title:'更新时间',width:120,sortable:true,align:'center'},
		...
		init:function(){
			...
			$('#delAllLine_btn').click(function(){
				YiYa.confirm('确定','你确定要删除记录吗？',function(r){
