...
import com.agent.czb.web.system.bean.SysRole;
...
import com.agent.czb.web.system.service.SysRoleService;
import com.agent.czb.web.system.service.SysUserService;
import com.agent.czb.web.system.utils.HtmlUtil;
import com.agent.czb.web.system.utils.MethodUtil;
...
public class SysUserAction extends BaseAction {
    ...
    public ModelAndView list(SysUserModel model, HttpServletRequest request) throws Exception {
        ...
        return forword("system/sysUser", context);
    }
    ...
    public void save(SysUser bean, HttpServletResponse response) throws Exception {
        int count = sysUserService.getUserCountByUserName(bean.getUserName());
        if (bean.getId() == null) {
            if (count > 0) {
    ...
    public ModelAndView userRole(HttpServletRequest request) throws Exception {
        Map<String, Object> context = getRootMap();
        return forword("/system/sysUserRole", context);
    }
    ...
    public void getUser(Integer id, HttpServletResponse response) throws Exception {
        ...
        data.put("email", bean.getUserName());
