    ...
    <div id="edit-win" class="easyui-dialog" title="基本信息"
        ...
        <form id="editForm" class="ui-form" method="post">
            ...
            <div class="ui-edit">
                ...
                <div class="fitem">
                    <label>车牌号码:</label>
                    <input class="easyui-validatebox" type="text" name="plateNum" data-options="">
                </div>
                <div class="fitem">
                    <label>预约状态:</label>
                ...
                <div class="fitem">
                    <label>预约时间:</label>
                    <input class="easyui-validatebox" type="text" name="time" data-options="">
                </div>
                <div class="fitem">
                    <label>金额:</label>
                    <input class="easyui-validatebox" type="text" name="totalPrice" data-options="">
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript" src="${msUrl}/static/js/ux/park/parkAppointInfo.js"></script>
</body>
</html>
