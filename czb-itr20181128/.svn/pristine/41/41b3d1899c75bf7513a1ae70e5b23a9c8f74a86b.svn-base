  			...
  			dataGrid:{
  				title:'系统用户列表',
	   			...
	   			columns:[[
						...
						{field:'userName',title:'登录名',align:'center',width:120,sortable:true},
						{field:'nickName',title:'昵称',align:'center',width:80,sortable:true},
						{field:'state',title:'状态',width:80,align:'center',sortable:true, formatter:function(value,row,index){
	                        if(value==0){
	                            return "可用";
	                        }if(value==1){
	                            return "禁用";
						...
						{field:'loginCount',title:'登陆总数',align:'center',width:80,sortable:true},
						{field:'loginTime',title:'登陆时间',align:'center',width:120,sortable:true}
				]],
				toolbar:[
