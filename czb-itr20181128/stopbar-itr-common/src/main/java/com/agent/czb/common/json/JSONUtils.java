package com.agent.czb.common.json;
...
public class JSONUtils {
    ...
    public static void main(String[] args) {
        ResultHelp help = new ResultHelp();
        help.setStatus(1);
        help.setMsg("1222");
        System.out.println(JSON.toJSONString(help, SerializerFeature. WriteMapNullValue));
        System.out.println(ToJsonString(help));
        System.out.println(objectToJson(help, "0"));
        System.out.println(objectToJson(help, "1"));
    }
}